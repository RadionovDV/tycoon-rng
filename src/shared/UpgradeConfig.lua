...
return {
	...
	luck_2 = {
		cost = 500, currency = "coins", requires = "luck_1",
	...
	moreenemies_2 = {
		cost = 2000, currency = "coins", requires = "moreenemies_1",
		effect = "enemyCount", value = 1,
	...
	autoll = {
		cost = 1000, currency = "coins", requires = "moreenemies_1",
	...
	rocks_unlock = {
		cost = 2000, currency = "coins", requires = "moreenemies_2",
