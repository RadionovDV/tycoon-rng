...
function Connection.Disconnect(self: SignalConnection)
	...
	local currentConnection = self
	if self._signal._handlerListHead and self._signal._handlerListHead == currentConnection then
...
function Signal.new(): ClassType
	...
	return setmetatable(self, Signal) :: ClassType
end
