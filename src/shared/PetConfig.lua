...
local PET_LIST = {
	...
	{ id = "Rare_Geode",     weight = 10,  rarity = "Rare",      damage = 80,  hp = 120, displayName = "Geode"   },
	{ id = "Epic_Crystal",   weight = 2,  rarity = "Epic",      damage = 200, hp = 250, displayName = "Crystal" },
	{ id = "Legendary_Gem",  weight = 0.5,   rarity = "Legendary", damage = 600, hp = 500, displayName = "Gem"     },
	{ id = "Divine_Opal",    weight = 0.01,   rarity = "Divine",    damage = 2000,hp = 2000,displayName = "Opal"    },
}
